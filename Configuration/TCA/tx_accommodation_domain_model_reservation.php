...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'name,surname,email,phone,number_of_people,message,privacy_confirmation,salutation,accommodation,',
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, surname, email, phone, number_of_people, message, privacy_confirmation, salutation, accommodation',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, surname, email, phone, number_of_people, message, privacy_confirmation, salutation, accommodation, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
