...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'name,teaser,description,occupancy,price,unit,price_information,main_image,images,facilities,reservations,',
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, teaser, description, occupancy, price, unit, price_information, main_image, images, facilities, reservations',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, teaser, description;;;richtext:rte_transform[mode=ts_links], occupancy, price, unit, price_information, main_image, images, facilities, reservations, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
